...
const pages = new Map<string, { title: string; body: string }>([
  ...
  ])}\n\n${section("Community", ["I am part of the Malaysian AI Residency and a Cursor Ambassador. I help run hackathons, meetups, and student builder sessions.", link("Event case studies", "/events")])}\n\n${section("Away from work", ["I play Valorant, watch scripted Minecraft videos, and ski in Gulmarg. Kashmir still feels like home.", link("Reading notes", "/books"), link("Interactive home in Kashmir", "/house"), link("Dal Lake from a houseboat", "/dal")])}\n\n${section("Contact", [contact])}` }],
  ...
  ["/house", { title: "Home, in Kashmir", body: "An interactive exterior reconstruction of my home in Kashmir. The browser view lets you rotate and zoom to explore its twin gables, stone walls, balconies, and carved wooden doors.\n\n" + link("Dal Lake from a houseboat", "/dal") + "\n\n" + link("About Mohtasham", "/about") }],
  ["/dal", { title: "Dal Lake, from a houseboat", body: "A procedural risograph short: the view from inside a Kashmiri houseboat onto Dal Lake, with the Zabarwan range beyond. Four inks, a 32-second loop, no photographs.\n\n" + link("Interactive home in Kashmir", "/house") + "\n\n" + link("About Mohtasham", "/about") }],
]);
